...
/**
 * Class to measure and draw the time in the {@link com.klinker.deskclock.CircleTimerView}.
...
public class CountingTimerView extends View {
     ...
     * {@link com.klinker.deskclock.CircleTimerView#onDraw(android.graphics.Canvas)}
     */
